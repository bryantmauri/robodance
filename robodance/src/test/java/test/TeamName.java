...
public class TeamName {
	...
	public void testCreateButton() {
		...
		home.clickStartCompetition();
		Competition match = new Competition(driver);
		a.assertFalse(match.createTeamButtonTest(1),
				"Team 1, You still have no entered no name, the button should still be disabled");
		a.assertFalse(match.createTeamButtonTest(2),
				"Team 2, You still have no entered no name, the button should still be disabled");
		match.enterTeamName(1, "Test1");
		match.enterTeamName(2, "Test2");
		a.assertFalse(match.createTeamButtonTest(1),
				"Team 1, Your name is too short, the button should still be disabled");
		a.assertFalse(match.createTeamButtonTest(2),
				"Team 2, Your name is too short, the button should still be disabled");
