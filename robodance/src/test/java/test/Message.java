...
public class Message {
	...
	public void WinnerOrLoserMessage() throws InterruptedException {
		...
		a.assertFalse(battleResult1.equals(battleResult2),
				"Robot1 is a: " + battleResult1 + " and Robot2 also a: " + battleResult2 + "which is impossible");
		driver.quit();
		a.assertAll();
	}
	...
	public void SelectedForBattleMessage() throws InterruptedException {
		...
		a.assertFalse(battleResult1.equals(battleResult2), "Robot1 is a: " + battleResult1
				+ " before click and then is " + battleResult2 + "after the click which is impossible");
		driver.quit();
		a.assertAll();
	}
